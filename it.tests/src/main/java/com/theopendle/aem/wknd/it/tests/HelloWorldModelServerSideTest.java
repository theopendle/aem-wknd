 ...
 */
package com.theopendle.aem.wknd.it.tests;

import com.theopendle.aem.wknd.core.models.HelloWorldModel;
...
public class HelloWorldModelServerSideTest {
    ...
    public void prepareData() throws Exception {
        new AdminResolverCallable() {
            @Override
            protected void call0(final ResourceResolver rr) throws Exception {
    ...
    public void cleanupData() throws Exception {
        new AdminResolverCallable() {
            @Override
            protected void call0(final ResourceResolver rr) throws Exception {
                final Resource testResource = rr.getResource("/tmp/testResource");
    ...
    public void testHelloWorldModelServerSide() throws Exception {
        ...
        new AdminResolverCallable() {
            ...
            protected void call0(final ResourceResolver rr) throws Exception {
                ...
                final HelloWorldModel hello = testResource.adaptTo(HelloWorldModel.class);
    ...
    private abstract class AdminResolverCallable implements Callable<Void> {
        ...
        public Void call() throws Exception {
            ...
            @SuppressWarnings("deprecation") final // fine for testing
